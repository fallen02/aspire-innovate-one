...
const partner_Node = document.querySelector('.partners')
const partner_Options = { loop: true }
const partner_plugins = [ EmblaCarouselAutoScroll({ stopOnInteraction: false }) ]
const partner_Api = EmblaCarousel(partner_Node, partner_Options, partner_plugins)
console.log(partner_Api.slideNodes())
